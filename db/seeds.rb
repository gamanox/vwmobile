...
cars = Car.create([
	{name:'Nuevo Polo GTI',subcategory_id:1,list_price: 860900},
	{name:'Golf GTI',subcategory_id:1,list_price: 860900},
	{name:'The Beetle',subcategory_id:1,list_price: 860900},
	{name:'CrossFox',subcategory_id:2,list_price: 860900},
	{name:'Jetta',subcategory_id:2,list_price: 860900},
	{name:'Gol',subcategory_id:3,list_price: 860900},
	{name:'Polo',subcategory_id:3,list_price: 860900},
	{name:'Gol Sedan',subcategory_id:3,list_price: 860900},
	{name:'Golf',subcategory_id:4,list_price: 860900},
	{name:'Clasico',subcategory_id:4,list_price: 860900},
	{name:'Golf SW',subcategory_id:4,list_price: 860900},
	{name:'Volkswagen CC',subcategory_id:5,list_price: 860900},
	{name:'Passat',subcategory_id:5,list_price: 860900},
	{name:'Tiguan',subcategory_id:6,list_price: 860900},
	{name:'Touareg',subcategory_id:6,list_price: 860900},
	{name:'Touareg Edition X',subcategory_id:6,list_price: 860900}])

versions = Version.create([
		{name: 'Sport Style 1.4a',description:'Suspensión delantera y trasera, A/C con temperatura independiente en dos zonas, volante multifunciones en piel con calefacción, paletas de cambios y más', car_id:1,list_price: 860900},
		{name: 'Sport Style 1.4b',description:'Suspensión delantera y trasera, A/C con temperatura independiente en dos zonas, volante multifunciones en piel con calefacción, paletas de cambios y más', car_id:1,list_price: 860900},
		{name: 'Sport Style 1.4c',description:'Suspensión delantera y trasera, A/C con temperatura independiente en dos zonas, volante multifunciones en piel con calefacción, paletas de cambios y más', car_id:1,list_price: 860900}
	])
